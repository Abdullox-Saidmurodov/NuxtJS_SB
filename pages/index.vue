...
<template>
    ...
    <main class="pb-72">
        ...
        <!-- Tab section -->
        <section>
            <h1 class="text-4xl font-medium px4">All from a single source of truth</h1>
        ...
        <section>
            ...
            <div class="flex items-center justify-between max-w-xl mx-auto mt-4">
                ...
                <div class="flex-1 h-2 
                            bg-gradient-to-r from-blue-500 dark:from-blue-800 to-gray-500 dark:to-gray-800"></div>
            ...
            <div class="grid grid-cols-2 mt-20">
                <div class="bg-blue-500 dark:bg-blue-800 p-8">
                        ...
                        <div class="flex flex-col mt-4">
                            <div class="">
                                <div class="bg-gray-500 dark:bg-gray-800 flex items-center gap-5 h-20">
                                    <div class="flex jusfy-center items-center bg-blue-500/30 dark:bg-blue-800/30 p-3 h-full">
                    ...
                    <div class="py-4 mt-12 rounded-r-full flex flex-col space-y-2
                                bg-gradient-to-l from-gray-500 dark:from-gray-800 to-blue-500 dark:to-blue-800">
                        <Icon name="bxs:quote-alt-left" class="text-7xl" />
